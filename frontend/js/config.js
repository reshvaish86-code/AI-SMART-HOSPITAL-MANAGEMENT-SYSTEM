 ...
 * Includes 10 Certified Specialists Across 10 Tamil Nadu Districts For Every Specialty
 */
...
const CONFIG = {
  ...
  DEFAULT_DOCTORS: [
    {
        "_id": "doc_dr__katrina_fernandez_1",
        "user": {
    ...
    {
        "_id": "doc_dr__nethra_sundaram_51",
        "user": {
    ...
    {
        "_id": "doc_dr__lavanya_swaminathan_81",
        "user": {
